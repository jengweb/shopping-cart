...
func Test_ConfirmPayment_Input_OrderID_8004359103_And_PaymentDetail_Should_Be_GetOrderProduct_Return_Error(t *testing.T) {
	expectedMessage := ""
	...
	mockOrderRepository := new(mockOrderRepository)
	mockOrderRepository.On("GetOrderProduct", orderId).Return([]order.OrderProduct{}, errors.New("GetOrderProduct Error"))
...
func Test_ConfirmPayment_Input_OrderID_8004359103_And_PaymentDetail_Should_Be_UpdateStock_Return_Error(t *testing.T) {
	...
	mockProductRepository := new(mockProductRepository)
	mockProductRepository.On("UpdateStock", 2, 1).Return(errors.New("UpdateStock Error"))
...
func Test_ConfirmPayment_Input_OrderID_8004359103_And_PaymentDetail_Should_Be_ShipByKerry_Return_Error(t *testing.T) {
	expectedMessage := ""
	...
	mockShippingGateway := new(mockShippingGateway)
	mockShippingGateway.On("ShipByKerry", shippingInfo).Return("", errors.New("ShipByKerry Error"))
